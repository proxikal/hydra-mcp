...
// testTransport is an in-memory transport for testing (simpler than channelTransport).
...
func (t *testTransport) DetectProtocol(_ time.Duration) (transport.Protocol, error) {
